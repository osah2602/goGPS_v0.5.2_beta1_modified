...
classdef goGUIclass < handle
    ...
    % Look initPopUps for the complete initialization
        ...
        strTropoModel = {};  % Pop up list of combine tropospheric models
        strhTropoModel = {}; %Pop up list of hydrostatic tropospheric models
        strwTropoModel = {}; %Pop up list of wet tropospheric models
        strhMFModel = {};    %Pop up list of hydrostatic Mapping Function models
        strwMFModel = {};    %Pop up list of wet Mapping Function models
        strMetModel = {};    %Pop up list of Meorological paramters models
        strUEMsource = {};   %Pop up list of source of User Entered Meteorological parameters
        strTmModel = {}; %Pop up list of  Weighted Mean Temperature(Tm) models
...
%             %1.COMBINE TROPOSPHERIC MODELS
%             this.strTropoModel{1}  = 'no model';
%             this.strTropoModel{2}  = 'Saastamoinen';
%             this.strTropoModel{3}  = 'Modified Saastamoinen';
%             this.strTropoModel{4}  = 'Hopfield';
%             this.strTropoModel{5}  = 'Modified Hopfield(Goads & Goodman)';
%             this.strTropoModel{6}  = 'Black';
%             this.strTropoModel{7}  = 'Marini';
%             this.strTropoModel{8}  = 'Askne & Nordius';
%             this.strTropoModel{9}  = 'UNB3m';
%             this.strTropoModel{10} = 'EGNOS';
%             this.strTropoModel{11} = 'MOPS';
%             this.strTropoModel{11} = 'GPT2 (5° x 5°)';
%             this.strTropoModel{12} = 'GPT2w (1° x 1°)';
%             this.strTropoModel{13} = 'GPT2w (5° x 5°)';
%             this.strTropoModel{14} = 'GPT3 (1° x 1°)';
%             this.strTropoModel{15} = 'GPT3 (5° x 5°)';
%             this.strTropoModel{16} = 'VMF ZTD';
%             
%             this.initTropoModel(this.strTropoModel, 2);%set default
%             
%             %2.SEPARATE(DRY,WET) TROPOSPHERIC MODELS
%             %2.1 HYDROSTATIC(DRY) MODELS
%             this.strhTropoModel{1}  = 'Saastamoinen';
%             this.strhTropoModel{2}  = 'Hopfield';
%             this.strhTropoModel{3}  = 'Modified Hopfield(Goads & Goodman)';
%             this.strhTropoModel{4}  = 'Askne & Nordius';
%             this.strhTropoModel{5}  = 'Davis et al';
%             this.strhTropoModel{6}  = 'Black';
%             this.strhTropoModel{7}  = 'UNB3m';
%             this.strhTropoModel{8}  = 'EGNOS';
%             this.strhTropoModel{9}  = 'MOPS';
%             this.strhTropoModel{10} = 'GPT2 (5° x 5°)';
%             this.strhTropoModel{11} = 'GPT2w (1° x 1°)';
%             this.strhTropoModel{12} = 'GPT2w (5° x 5°)';
%             this.strhTropoModel{13} = 'GPT3 (1° x 1°)';
%             this.strhTropoModel{14} = 'GPT3 (5° x 5°)';
%             this.strhTropoModel{15} = 'VMF ZHD';
%             
%             this.initTropoModel(this.strhTropoModel, 1);        
%            
%             %2.2 WET MODELS
%             this.strwTropoModel{1}  = 'Saastamoinen';
%             this.strwTropoModel{2}  = 'Hopfield';
%             this.strwTropoModel{3}  = 'Modified Hopfield(Goads & Goodman)';
%             this.strwTropoModel{4}  = 'Ifadis';
%             this.strwTropoModel{5}  = 'Chao';
%             this.strwTropoModel{6}  = 'Berman 70';
%             this.strwTropoModel{7}  = 'Berman 74';
%             this.strwTropoModel{8}  = 'Berman TMOD';
%             this.strwTropoModel{9}  = 'Callahan';
%             this.strwTropoModel{10} = 'Mendes';
%             this.strwTropoModel{11} = 'Askne & Nordius';
%             this.strwTropoModel{12} = 'UNB3m';
%             this.strwTropoModel{13} = 'EGNOS';
%             this.strwTropoModel{14} = 'MOPS';
%             this.strwTropoModel{15} = 'GPT2 (5° x 5°)';
%             this.strwTropoModel{16} = 'GPT2w (1° x 1°)';
%             this.strwTropoModel{17} = 'GPT2w (5° x 5°)';
%             this.strwTropoModel{18} = 'GPT3 (1° x 1°)';
%             this.strwTropoModel{19} = 'GPT3 (5° x 5°)';
%             this.strwTropoModel{20} = 'VMF ZWD';
%             
%             this.initTropoModel(this.strwTropoModel, 1);              
        ...
        function initIonoModel(this, str, defaultVal)
            ...
            set(this.goh.pop_lIono_correction, 'String', str);
            set(this.goh.pop_lIono_correction, 'Value', defaultVal);
        end
    ...
    methods (Access = 'private');
        ...
        function initUIids(this)
          ...
          % ---------------------------------------------------------------
            ...
            i=i+1; id.tIono          = i;    id2h(i) = this.goh.text_lIono_correction;
            i=i+1; id.lIono          = i;    id2h(i) = this.goh.pop_lIono_correction;
            i=i+1; id.tTropo         = i;    id2h(i) = this.goh.text_tropo;
            i=i+1; id.lTropo         = i;    id2h(i) = this.goh.pop_lTropo_combine;
