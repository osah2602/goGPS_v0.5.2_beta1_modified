...
%USAGE:                                                                    *
%      General:                                                            *
%             [STD,SHD,SWD,ZTD,ZHD,ZWD]=TropModel_SAAS(ReceiverPos,SatPos,.*
%                                      Temperature,Pressure,WaterVaporPres)*
%      Others:                                                             *
%I.         [STD,SHD,SWD,ZTD,ZHD,ZWD]=TropModel_SAAS(ReceiverPos,SatPos,...*
%                                                                [T  P  e])*
%II.        [STD,SHD,SWD,ZTD,ZHD,ZWD]=TropModel_SAAS(ReceiverPos,SatPos,...*
%                                                  Temperature,Pressure,[])*
%III.       [STD,SHD,SWD,ZTD,ZHD,ZWD]=TropModel_SAAS(ReceiverPos,SatPos,...*
%                                                   Temperature,[],[])     *
%IV.        [STD,SHD,SWD,ZTD,ZHD,ZWD]=TropModel_SAAS(ReceiverPos,SatPos,...
%                                                                [],[],[]) *   
%V.         [STD,SHD,SWD,ZTD,ZHD,ZWD]=TropModel_SAAS(ReceiverPos,SatPos)   *                     
%VI.        [STD,SHD,SWD,ZTD,ZHD,ZWD]=TropModel_SAAS(height,satElevation,..*
%                                      Temperature,Pressure,WaterVaporPres)*
%VII.       [STD,SHD,SWD,ZTD,ZHD,ZWD]=TropModel_SAAS(height,satElevation,..*
%                                                                 [],[],[])*
%VIII.      [STD,SHD,SWD,ZTD,ZHD,ZWD]=TropModel_SAAS(height,satElevation)  *
%IX.        [STD,SHD,SWD,ZTD,ZHD,ZWD]=TropModel_SAAS([],satElevation)      *
%X.         [STD,SHD,SWD,ZTD,ZHD,ZWD]=TropModel_SAAS([],satElevation,...   *
%                                      Temperature,Pressure,WaterVaporPres)*
%XI.        [STD,SHD,SWD,ZTD,ZHD,ZWD]=TropModel_SAAS([],[],Temperature...  *
...
function [STD,SHD,SWD,ZTD,ZHD,ZWD] = TropModel_SAAS(ReceiverPos,SatPos,Temperature,...
                                                   Pressure,WaterVaporPres)
...
ZWD = (0.002277.*((1255 ./ T) + 0.05).* es)./dgref;% Zenith wet delay[m]

%****FINALLY, COMPUTE ZENITH TOTAL DELAY(ZTD)
try
   ZTD = ZHD + ZWD;%Zenith Total Delay [m]
catch    
       ZTD = (0.002277 .*(P + ((1255 ./ T) + 0.05).* es))./dgref; %Zenith Total Delay[m]
end 
...
[STD,SWD,Zd] = deal(SHD);%copy the contents of SHD to all the requested outputs
...
for i = 1:ncol %Loop over the Number of Receiver positions
   ...
   for j = 1:nrow %Loop over the Number of Satellite Elevations
      ...
      SHD(j,i) = ((0.002277./cos(Zd(j,i))).* P(i,1))./dgref(i,1); %[m]

      %*****COMPUTE SLANT WET DELAY(SWD)
      SWD(j,i) = ((0.002277./cos(Zd(j,i))) .* (((1255 ./ T(i,1)) + 0.05).* es(i,1)))./dgref(i,1);%[m]
      
      %****FINALLY, COMPUTE SLANT TOTAL DELAY(STD)
      try
         STD(j,i) = SHD(j,i)+SWD(j,i);%[m]
      catch      
           STD(j,i) = ((0.002277./cos(Zd(j,i))) .* (P(i,1) + ((1255 ./ T(i,1)) + 0.05).* es(i,1)))./dgref(i,1); %[m]
      end   
