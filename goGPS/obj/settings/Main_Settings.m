...
%         TROPO_MODEL = 3;                                % Combined(Dry+Wet) Tropospheric model to be used (0: none, 1: Saastamoinen std parameters, 2: Saastamoinen global pararameters)
                                                        % - tropo_model =  0: no model
                                                        % - tropo_model =  1: Saastamoinen model 
                                                        % - tropo_model =  2: Modified Saastamoinen model                                                     
                                                        % - tropo_model =  3: Hopfield model 
                                                        % - tropo_model =  4: Modified Hopfield (Goads & Goodman) model 
                                                        % - tropo_model =  5: Black model
                                                        % - tropo_model =  6: Marini model
                                                        % - tropo_model =  7: Askne & Nordius
                                                        % - tropo_model =  8: UNB3m model
                                                        % - tropo_model =  9: EGNOS model
                                                        % - tropo_model = 10: MOPS model
                                                        % - tropo_model = 11: GPT2 (5° x 5°)
                                                        % - tropo_model = 12: GPT2w (1° x 1°)
                                                        % - tropo_model = 13: GPT2w (5° x 5°)
                                                        % - tropo_model = 14: GPT3 (1° x 1°)
                                                        % - tropo_model = 15: GPT3 (5° x 5°)
                                                        % - tropo_model = 16: VMF ZTD
                                                                           
%        hTROPO_MODEL = 1;                                %   Hydrostatic Tropospheric model to be used (1: Saastamoinen, 2: Hopfield)
                                                        % - htropo_model =  1: Saastamoinen model                                                    
                                                        % - htropo_model =  2: Hopfield model 
                                                        % - htropo_model =  3: Modified Hopfield (Goads & Goodman) model 
                                                        % - htropo_model =  4: Askne & Nordius
                                                        % - htropo_model =  5: Davis et al model
                                                        % - htropo_model =  6: Black model
                                                        % - htropo_model =  7: UNB3m model
                                                        % - htropo_model =  8: EGNOS model
                                                        % - htropo_model =  9: MOPS model
                                                        % - htropo_model = 10: GPT2 (5° x 5°)
                                                        % - htropo_model = 11: GPT2w (1° x 1°)
                                                        % - htropo_model = 12: GPT2w (5° x 5°)
                                                        % - htropo_model = 13: GPT3 (1° x 1°)
                                                        % - htropo_model = 14: GPT3 (5° x 5°)
                                                        % - htropo_model = 15: VMF ZHD
                                                        
%        wTROPO_MODEL = 1;                                % Wet Tropospheric model to be used (1: Saastamoinen std parameters, 2: Saastamoinen global pararameters)
                                                        % - wtropo_model =  1: Saastamoinen model                                                                                                     
                                                        % - wtropo_model =  2: Hopfield model 
                                                        % - wtropo_model =  3: Modified Hopfield (Goads & Goodman) model 
                                                        % - wtropo_model =  4: Ifadis model
                                                        % - wtropo_model =  5: Chao model
                                                        % - wtropo_model =  6: Berman 70 model
                                                        % - wtropo_model =  7: Berman 74 model
                                                        % - wtropo_model =  8: Berman TMOD model
                                                        % - wtropo_model =  9: Callahan model
                                                        % - wtropo_model = 10: Mendes model
                                                        % - wtropo_model = 11: Aske & Nordius model
                                                        % - wtropo_model = 12: UNB3m model
                                                        % - wtropo_model = 13: EGNOS model
                                                        % - wtropo_model = 14: MOPS model
                                                        % - wtropo_model = 15: GPT2 (5° x 5°) model
                                                        % - wtropo_model = 16: GPT2w (1° x 1°) model
                                                        % - wtropo_model = 17: GPT2w (5° x 5°) model
                                                        % - wtropo_model = 18: GPT3 (1° x 1°) model
                                                        % - wtropo_model = 19: GPT3 (5° x 5°) model
                                                        % - wtropo_model = 20: VMF ZWD model
                                                        
%          hMF_MODEL = 12;                                % Hydrostatic Mapping Function model to be used (1: Saastamoinen 2: Hopfield)                                                        
                                                        % - hmf_model =  1: Saastamoinen model                                                    
                                                        % - hmf_model =  2: Hopfield model  
                                                        % - hmf_model =  3: Moffett model
                                                        % - hmf_model =  4: Ifadis model
                                                        % - hmf_model =  5: Chao model
                                                        % - hmf_model =  6: Herring model
                                                        % - hmf_model =  7: Davis model
                                                        % - hmf_model =  8: Black model
                                                        % - hmf_model =  9: Black & Eisner model
                                                        % - hmf_model = 10: Simple model
                                                        % - hmf_model = 11: GMF model
                                                        % - hmf_model = 12: NMF model 
                                                        % - hmf_model = 13: VMF1(1° x 1°) model 
                                                        % - hmf_model = 14: VMF1(5° x 5°) model 
                                                        % - hmf_model = 15: VMF3(1° x 1°) model 
                                                        % - hmf_model = 16: VMF3(5° x 5°) model 
                                                        
%               wMF_MODEL = 11;                          % Wet Mapping Function model to be used (1: Saastamoinen 2: Hopfield)                                                        
                                                        % - wmf_model =  1: Saastamoinen model                                                    
                                                        % - wmf_model =  2: Hopfield model  
                                                        % - wmf_model =  3: Moffett model
                                                        % - wmf_model =  4: Ifadis model
                                                        % - wmf_model =  5: Chao model
                                                        % - wmf_model =  6: Herring model
                                                        % - wmf_model =  7: Black model
                                                        % - wmf_model =  8: Black & Eisner model
                                                        % - wmf_model =  9: Simple model
                                                        % - wmf_model = 10: GMF model
                                                        % - wmf_model = 11: NMF model 
                                                        % - hmf_model = 12: VMF1(1° x 1°) model 
                                                        % - hmf_model = 13: VMF1(5° x 5°) model 
                                                        % - hmf_model = 14: VMF3(1° x 1°) model 
                                                        % - hmf_model = 15: VMF3(5° x 5°) model 
                                                        
                                                        
%          MET_MODEL = 1;                                 % Meteorological parameter model to be used (1: Saastamoinen 2: Hopfield)                                                        
                                                        % - met_model =  1: 1.Standard Meteorological Parameters model                                                    
                                                        % - met_model =  2: 2.Generate from GPT model                                                         
                                                        % - met_model =  3: 3.Generate from GPT2 model
                                                        % - met_model =  4: 4.Generate from GPT2w model
                                                        % - met_model =  5: 5.Generate from GPT3 model
                                                        % - met_model =  6: 6.Generate from UNB3m model
                                                        % - met_model =  7: 7.Enter Meteorological Parameters model
                                                        % - met_model =  8: 8.Import from csv file[T P RH]                                               
                                                                                                                                            
%         Tm_MODEL = 1;                                  % Weightd mean Temperature(Tm) model to be used (1: Saastamoinen 2: Hopfield)                                                        
                                                        % - Tm_model =  1: Bevis et al (1992,1994)model                                                    
                                                        % - Tm_model =  2: 2: Bevis et al (1995)model                                                         
                                                        % - Tm_model =  3: Mendes et al (2000) model
                                                        % - Tm_model =  4: Schueler et al (2001) model
                                                        % - Tm_model =  5: Yao et al (2014) model
                                                        % - Tm_model =  6: GWMT-I model  
                                                        % - Tm_model =  7: GWMT-II model
                                                        % - Tm_model =  8: GWMT-III model
                                                        % - Tm_model =  9: GTVR-Tm
                                                        % - Tm_model =  10: GPT2w model
                                                        % - Tm_model =  11: GPT3 model
                                                        % - Tm_model =  12: UNB3m model
                                                        % - Tm_model =  13: Simple PI function model                                                                                                 
...
% %         % id to string of combined tropospheric models
% %         TROPO_SMODE = {'0: no model', ...
% %                        '1: Saastamoinen', ...
% %                        '2: Modified Saastamoinen', ...
% %                        '3: Hopfield', ...
% %                        '4: Modified Hopfield(Goads & Goodman)', ...
% %                        '5: Black', ... 
% %                        '6: Marini', ...
% %                        '7: Askne & Nordius', ...
% %                        '8: UNB3m', ...
...
% %                       '16: VMF ZTD'}
% %                   
% %   % id to string of hydrostatic tropospheric models
% %        TROPO_ShMODE = {'1: Saastamoinen', ...
% %                        '2: Hopfield', ...
% %                        '3: Modified Hopfield(Goads & Goodman)', ...
% %                        '4: Askne & Nordius', ... 
% %                        '5: Davis et al', ...
% %                        '6: Black', ...
% %                        '7: UNB3m', ...
...
% %                       '15: VMF ZHD'}
% %                        
% %        % id to string of wet tropospheric models
% %        TROPO_SwMODE = {'1: Saastamoinen', ...
% %                        '2: Hopfield', ...
% %                        '3: Modified Hopfield(Goads & Goodman)', ...
% %                        '4: Ifadis', ...
% %                        '5: Chao', ... 
...
% %         
% %                                
% %         % id to string of hydrostatic MF models
% %         MF_ShMODE = {'1: Saastamoinen', ...
% %                      '2: Hopfield', ...
% %                      '3: Moffett', ...
% %                      '4: Ifadis', ... 
% %                      '5: Chao', ...
...
% %   
% %                                                         
% %          % id to string of wet MF models
% %          MF_SwMODE = {'1: Saastamoinen', ...
% %                       '2: Hopfield', ...
% %                       '3: Moffett', ...
% %                       '4: Ifadis', ... 
% %                       '5: Chao', ...
...
% %                      '15: VMF3(5° x 5°)'} 
% %                                        
% %          % id to string of source of Meteorological parameters
% %          MET_SMODE = {'1: 1.Standard Meteorological Parameters', ...
% %                       '2: 2.Generate from GPT model', ...
% %                       '3: 3.Generate from GPT2 model', ...
% %                       '4: 4.Generate from GPT2w model', ... 
% %                       '5: 5.Generate from GPT3 model', ...
% %                       '6: 6.Generate from UNB3m model', ...
% %                       '7: 7.Enter Meteorological Parameters', ...
% %                       '8: 8.Import from csv file[T P RH]'} 
% %                                           
% %        % id to string of source of User Entered Meteorological parameters
% %      MET_UES_SMODE = {'1: SELECT SOURCE', ...
% %                       '2: Weather Station', ...
% %                       '3: Numeric Weather Prediction(NWP)', ...
% %                       '4: In-Situ measurement'} 
% %                                 
% %               % id to string of Weighted Mean Temperature(Tm) models
% %           Tm_SMODE = {'1: Bevis et al (1992,1994)model', ...
% %                       '2: Bevis et al (1995)model', ...
% %                       '3: Mendes et al (2000) model', ...
% %                       '4: Schueler et al (2001) model', ... 
% %                       '5: Yao et al (2014) model', ...
% %                       '6: GWMT-I model', ...
% %                       '7: GWMT-II model', ...
% %                       '8: GWMT-III model', ...
% %                       '9: GTVR-Tm', ...
...
% %                      '13: Simple PI function model'}    
    ...
    properties (SetAccess = public, GetAccess = public)
        ...
        %Combine Tropospheric model to be used (0: none, 1: Saastamoinen std parameters, 2: Saastamoinen global pararameters)
